...
Even thought it is theoretically possible to have five-way distinction it is not present in our dataset. One-way contrast is present in non-indigenous languages (Azerbaijani, Kumyk, Nogai, Tat). The most frequent is two-way voiceless-ejective distinction that is present in majority of languages. The most frequent three-way distinction is voiceless-geminated-ejective distinction. The most frequent four-way distinction is voiceless-geminated-ejective-geminated ejective that is also attributed to the protolanguage [@nikolayev94; @nichols03]. This voiceless-geminated-ejective-geminated is present exclusively in Avar and Andic languages.
...
Laterals is the significant feature of Avar, Andic and Tsezic languages, however there is one Lezghian language, Archi, where they also were attested. In most cases lateral system is present by fricative ɬ and two affricates tɬ and tɬ'. Sometimes the subsystem even bigger when geminated version are present.
...
Lateral inventory can be differ from 1 (Tsova-Tush, ɬ) to 12 (Akhvakh, ɬ, tɬ, tɬ' all long, labialised and long labialized).
...
Most common scenario is one place of articulation (or none): either pharyngeal or epiglottal with voced and voiceless consonant. The rest zoo of systems is conected to epiglottal stop that is merged with different subsystems. There are also rare cases with just one pharyngeal consonant: ħ or ʢ.
